...
[Materials]
  [./area0]
    ...
    outputs = exodus
    block = 0
    output_properties = 'temperature density well_velocity specific_heat well_reynolds_no well_moody_friction viscosity diameter flow_pattern gas_velocity liquid_velocity mass_fraction gas_density liquid_density void_fraction current_phase superficial_gas_velocity superficial_liquid_velocity'
  [../]
  [./area1]
    type = MoskitoFluidWell2P
    pressure = p
