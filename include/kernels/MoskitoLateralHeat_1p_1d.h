...
class MoskitoLateralHeat_1p_1d;

template <>
InputParameters validParams<MoskitoLateralHeat_1p_1d>();

class MoskitoLateralHeat_1p_1d : public Kernel
{
public:
  MoskitoLateralHeat_1p_1d(const InputParameters & parameters);
